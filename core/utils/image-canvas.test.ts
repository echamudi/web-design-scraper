...
import { getPixelImageData, imageToCanvas, imageToImageData, setPixelImageData } from 'Core/utils/image-canvas';
...
test('getPixelImageData', async () => {
    ...
    expect(getPixelImageData(imageData, 0, 0)).toStrictEqual({ r: 255, g: 0, b: 0, a: 255 });
    expect(getPixelImageData(imageData, 3, 3)).toStrictEqual({ r: 255, g: 0, b: 0, a: 255 });
    expect(getPixelImageData(imageData, 7, 4)).toStrictEqual({ r: 255, g: 255, b: 0, a: 255 });
    expect(getPixelImageData(imageData, 9, 9)).toStrictEqual({ r: 255, g: 255, b: 0, a: 255 });
    ...
    expect(getPixelImageData(imageData2, 2, 1)).toStrictEqual({ r: 255, g: 0, b: 0, a: 255 });
});

test('setPixelImageData', async () => {
    const imageData = new ImageData(4, 3);

    expect(getPixelImageData(imageData, 2, 1)).toStrictEqual({ r: 0, g: 0, b: 0, a: 0 });
    setPixelImageData(imageData, 2, 1, {r: 4, g: 5, b: 6, a: 7});
    expect(getPixelImageData(imageData, 2, 1)).toStrictEqual({r: 4, g: 5, b: 6, a: 7});
    setPixelImageData(imageData, 2, 1, {r: 11, g: 12, b: 13});
    expect(getPixelImageData(imageData, 2, 1)).toStrictEqual({r: 11, g: 12, b: 13, a: 255});
});
